...
const handleVerify = async () => {
  ...
  try {
    // Use import.meta.env.VITE_BACKEND_URL or default to localhost
    ...
    // Update local state to show next step (Acquisition/Marketing)
    setAuthStep(3);
  } catch (err: any) {
    console.error("Verification failed", err);
    // set error state if you have one, or alert
